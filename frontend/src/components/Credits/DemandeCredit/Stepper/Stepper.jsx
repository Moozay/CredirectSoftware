    ...
    return (
      ...
      >
        <Flex position="relative" justifyItems={"center"}>
          ...
          >
            {step.completed ? (
              ...
              <span className={`${!step.selected ? "text-gray-400" : ""}`}>
                {index + 1}
              </span>
            )}
          </Box>
        ...
        <Box
          ...
          className={`transition duration-500 ease-out md:ease-in border-t-2 ${
    ...
    <>
      <form onSubmit={validateFormData} >
        ...
        >
          {/* Stepper */}
          <Flex
            bgColor={colorMode == "light" ? "#fff5ef" : "#07041d"}
          ...
          <Flex flexDir={"column"} px={16} pb={2} borderBottomRadius={"15px"}>
            ...
            >
              ...
              <Heading size={"sm"} textAlign="center" my="auto" w="20%">
              ...
              <IconButton
                ...
                icon={
                  currentStep > steps.length - 1 ? (
                    <Button m={2} size="md" variant="unstyled">
                      Soumettre
                    </Button>
                  ) : (
                    <AiFillCaretRight />
              ...
              <IconButton
                bgColor={colorMode == "light" ? "red" : "red"}
                variant={"outline"}
                onClick={(e) => {
                  setCurrentStep(1);
                  resetForm();
